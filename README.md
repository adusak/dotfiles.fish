<p align="center">
  ...
  <h2 align="center">adikove dotfiles</h2>
  <p align="center">Config files for Fish, Java, Ruby, Go, Editors, Terminals and more.</p>
</p>

---

Forked from my [ZSH dotfiles](https://github.com/adusak/dotfiles), those are
...
```console
$ git clone https://github.com/adusak/dotfiles.fish.git ~/.dotfiles
$ cd ~/.dotfiles
